...
<main id="main" class="main-site">
    <div class="container">
        ...
        <div class=" main-content-area">
            {{-- Check if Exits An Items In Carts --}}
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="product-name">
                                        <a class="link-to-product"
                                            href="{{route('Product.details',['slug' => $item->model->slug])}}">{{$item->name}}
                                        </a>
                                    </div>
                                    ...
                                    <div class="quantity">
                                        <div class="quantity-input">
                                            ...
                                            <a class="btn btn-increase"
                                                href="#" wire:click.prevent="increaseQuantity('{{$item->rowId}}')"></a>
                                            <a class="btn btn-reduce"
                                                href="#" wire:click.prevent="decreaseQuantity('{{$item->rowId}}')"></a>
                                        </div>
                                        <p class="text-center">
                ...
                <div class="summary">
                        ...
                        @if (session()->has('coupon'))
                            <p class="summary-info">
                                ...
                                <a href="#" wire:click.prevent="removeCoupon">
                                    <i class="fa fa-remove text-red-600"></i>
                                </a>
                                </span>
                                <b class="index">${{number_format($discount,2)}}</b>
                            </p>
                            <p class="summary-info">
                                <span class="title">Subtital with Discount</span>
                        ...
                        <div class="checkout-info">
                            @if (!session()->has('coupon'))
                                <label class="checkbox-field">
                                    <input class="frm-input" name="have-code" wire:model="havecouponcode"
                                    id="have-code" value="1" type="checkbox">
                                        ...
                                        <form wire:submit.prevent="applyCouponCode()">
                                            ...
                                            <p class="row-in-form">
                                                ...
                                                <input type="text" name="coupon-code"
                                                    class="form-control" wire:model="couponcode">
                                            </p>
                                            @if (session()->has('coupon_message'))
                                                <p class="text-red-600">{{session('coupon_message')}}</p>
                                            @endif
                    ...
                    <div class="update-clear">
                        <a class="btn btn-clear"
                            href="#" wire:click.prevent="destroyAll()">Clear Shopping Cart</a>
            ...
            <div class="wrap-show-advance-info-box style-1 box-in-site">
                ...
                <div class="wrap-products">
                    ...
                    data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},
                    "992":{"items":"3"},"1200":{"items":"5"}}' >

                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure>
                                        <img src="{{asset('assets/images/products/digital_04.jpg')}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    </figure>
                                </a>
                            ...
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{asset('assets/images/products/digital_17.jpg')}}"
                                        width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{asset('assets/images/products/digital_01.jpg')}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    </figure>
                                </a>
                                <div class="group-flash">
