...
<body class="home-page home-01 ">
                    ...
                    @if (Route::has('login'))
                        @auth
                            @if (Auth::user()->utype ==="ADM")
                                <li class="menu-item menu-item-has-children parent" >
                                    <a title="mu acount" href="#">
                                        My Acount ({{Auth::user()->name}})
                                    ...
                                    <ul class="submenu curency" >
                                        ...
                                        <li class="menu-item" >
                                            <a title="products"
                                                href="{{route('admin.product')}}">All Products</a>
                                        </li>
                                        <li class="menu-item" >
                                        ...
                                        <li class="menu-item" >
                                            <a title="manage home category"
                                                href="{{route('admin.homecategory')}}">Manage Home Categories</a>
                                        </li>
                                        <li class="menu-item" >
					...
					<div class="mid-section main-info-area">
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home">
                                <div class="logo">
                                    <h4 class="text_logo">Kabah Online</h4>
                                </div>
                            </a>
						</div>
    ...
    <script src="https://cdn.tiny.cloud/1/j4lkpz7l8mmyy6fla1mmtdtm9wb94m960zqxlfn15vjue7o2/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
