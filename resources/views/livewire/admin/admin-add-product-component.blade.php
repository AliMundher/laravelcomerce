                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data"
                            wire:submit.prevent="addProduct()" id="form_add_product">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @error('name') <p class='text-red-600 text-capitalize'>{{$message}}</p> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @error('slug') <p class='text-red-600 text-capitalize'>{{$message}}</p> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Short Description</label>
                                <div class="col-md-4" wire:ignore>
                                    <textarea type="text" class="form-control input-md" id="short_description"
                                        placeholder="Sort Description" name="sort_description"
                                        wire:model="short_description"></textarea>
                                    @error('short_description')
                                        <p class='text-red-600 text-capitalize'>{{$message}}</p> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Description</label>
                                <div class="col-md-4" wire:ignore>
                                    <textarea type="text" class="form-control input-md" id="description"
                                        placeholder="Description" name="description" wire:model="description" >
                                    </textarea>
                                    @error('description') <p class='text-red-600 text-capitalize'>{{$message}}</p> @enderror
                                </div>
                            </div>
                            <div class="form-group">
