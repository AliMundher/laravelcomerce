            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sal_price > 0 || $sale->status == 1 || $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                <span class="product-price">${{$product->sal_price}}</span>
                                <del>
                                    <span class=" regprice">{{$product->regular_price}}</span>
                                </del>
                            </div>
                        @else
                            <div class="wrap-price">
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                <input type="text" name="product-quatity"
                                    value="1" data-max="120" pattern="[0-9]*" wire:model="qty">
                        ...
                        <div class="wrap-butons">
                            ...
                            @else
                                ...
                                wire:click.prevent="store(
                                    {{$product->id}},
                                    '{{$product->name}}',
                                    {{$product->regular_price}})">Add To Cart
                                </a>
                            @endif
                            <div class="wrap-btn">
